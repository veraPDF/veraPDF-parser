...
public class PDType4FunctionTest {
    ...
    public void testGetResult(@ConvertWith(PDFunctionTest.ListOfCOSObjectsConverter.class) List<COSObject> operators,
                              @ConvertWith(PDFunctionTest.ListOfCOSObjectsConverter.class) List<COSObject> operands,
                              @ConvertWith(PDFunctionTest.ListOfCOSObjectsConverter.class) List<COSObject> result) {
    ...
    public void testGetResultWithInvalidOperators(@ConvertWith(PDFunctionTest.ListOfCOSObjectsConverter.class) List<COSObject> operators,
                              @ConvertWith(PDFunctionTest.ListOfCOSObjectsConverter.class) List<COSObject> operands) {
        func.setOperators(operators);
