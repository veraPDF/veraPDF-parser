...
[![Build Status](https://jenkins.openpreservation.org/job/veraPDF/job/1.26rc/job/parser/badge/icon)](https://jenkins.openpreservation.org/job/veraPDF/job/1.26rc/job/parser/ "OPF Jenkins")
