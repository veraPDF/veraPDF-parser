...
[![Build Status](https://jenkins.openpreservation.org/job/veraPDF/job/1.30rc/job/parser/badge/icon)](https://jenkins.openpreservation.org/job/veraPDF/job/1.30rc/job/parser/ "OPF Jenkins")
 ...
 * Java 8, 11, 17, 21 or 25, which can be downloaded [from Oracle](https://www.oracle.com/technetwork/java/javase/downloads/index.html), or for Linux users [OpenJDK](http://openjdk.java.net/install/index.html).
