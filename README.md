...
[![Build Status](https://jenkins.openpreservation.org/job/veraPDF/job/1.28rc/job/parser/badge/icon)](https://jenkins.openpreservation.org/job/veraPDF/job/1.28rc/job/parser/ "OPF Jenkins")
